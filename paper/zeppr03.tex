...
\title{La reelección municipal como póliza de seguro\thanks{Paper read at Tec de Monterrey's Political Science Conference, Feb.\ 27--28, 2026. I am grateful to Francisco Garfias for suggestions on an early draft of the paper, to Gabino Martínez Díaz and Rodrigo Santibáñez Razo for research assistance, and for the generous support of the Asociación Mexicana de Cultura A.C. The author bears full responsibility for errors and limitations in the study.}}
...
\begin{table}
  ...
  & Partido & ($\alpha_0 > \beta_0$) & ($\alpha_0 + \alpha_1) > (\beta_0 + \beta_1$) & $N$      \\ \hline
