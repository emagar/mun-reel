#########################################################
## Code to prepare data for ayuntamiento vote analysis ##
## Date started: 26nov2023                             ##
## Revised/updated: 22nov2025                          ##
...
tmp <- sub(pattern = "^([a-z]+[-][0-9]+)b([.0-9]+)$", replacement = "\\1\\2", tmp) ## drop those with bs
...
table(round(rowSums(v) - vot$efec, 2))
